...
const SKILL_DECKS = [
  ...
  },
  {
    ...
    tag: "Spatial Tech",
    skills: [
      { name: "Three.js", level: "3D WebGL" },
      { name: "GLSL Shaders", level: "GPU Math" },
      { name: "GSAP", level: "Scroll" },
      { name: "Framer Motion", level: "Spring UI" },
      { name: "Lenis", level: "Smooth" },
      { name: "Canvas 2D", level: "Interactive" },
    ],
  },
  {
    id: "media",
    ...
    skills: [
      ...
      { name: "Color Grading", level: "LUTs" },
      { name: "Sound Design", level: "Mastering" },
      { name: "Motion Graphics", level: "Keyframe" },
